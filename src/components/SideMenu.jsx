      ...
      <aside className="w-20  rounded-lg bg-gray-800 p-4 flex flex-col gap-48 items-center">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col gap-[40px]">
            ...
            <IoGrid onClick={() => navigate("/")}  className="w-8 h-8 text-[#5a698f] hover:text-white cursor-pointer transition-all"/>
            </div>
            <div className="w-8 h-8 rounded-md">
            ...
            <div className="w-8 h-8 rounded-md">
            <CiBookmark onClick={() => navigate("/bookmarks")} className="w-8 h-8  hover:text-white cursor-pointer transition-all text-[#5a698f]"/>
            </div>
          </div>
        </div>
        {/* Profile Icon */}
